# -*- coding: utf-8 -*-
# filename: crawler.py
# From https://gist.github.com/debrice/a34563fb078d9d2d15e8
# Modified for python 3.5 by Mark Strefford
...
def get_local_links(html, domain, url):
    """
    ...
    try:
        ...
        print("error [%s] %s: %s" % (domain, url, e))
        return ''
...
class Crawler(object):
    ...
    def curl(self, url):
        ...
        try:
            ...
            req = ('%s://%s%s' % (self.scheme, self.domain, url))
